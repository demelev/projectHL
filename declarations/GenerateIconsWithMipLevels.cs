...
internal class GenerateIconsWithMipLevels
{
    ...
    {
        <CreateIconWithMipLevels>c__AnonStorey2F storeyf = new <CreateIconWithMipLevels>c__AnonStorey2F {
            baseName = baseName,
            inputData = inputData
        };
        List<string> list = assetPathsOfAllIcons.FindAll(new Predicate<string>(storeyf.<>m__3D));
        ...
        if (BlitMip(iconWithMips, storeyf.inputData.GetMipFileName(storeyf.baseName, width), 0))
        {
        ...
        for (int i = 1; i < iconWithMips.mipmapCount; i++)
        {
            ...
            BlitMip(iconWithMips, storeyf.inputData.GetMipFileName(storeyf.baseName, mipResolution), i);
        }
    ...
    {
        <GetIconAssetPaths>c__AnonStorey30 storey = new <GetIconAssetPaths>c__AnonStorey30 {
        ...
        list.RemoveAll(new Predicate<string>(storey.<>m__3E));
    ...
    [CompilerGenerated]
    private sealed class <CreateIconWithMipLevels>c__AnonStorey2F
    {
        internal string baseName;
        internal GenerateIconsWithMipLevels.InputData inputData;

        internal bool <>m__3D(string o)
        {
    ...
    [CompilerGenerated]
    private sealed class <GetIconAssetPaths>c__AnonStorey30
    {
        internal string mustHaveIdentifier;

        internal bool <>m__3E(string o)
        {
