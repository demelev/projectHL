...
internal class ClangCompiler : NativeCompiler
{
    ...
    {
        <CompileDynamicLibrary>c__AnonStorey64 storey = new <CompileDynamicLibrary>c__AnonStorey64 {
            <>f__this = this
        };
        ...
        NativeCompiler.ParallelFor<string>(strArray, new Action<string>(storey.<>m__D2));
    ...
    [CompilerGenerated]
    private sealed class <CompileDynamicLibrary>c__AnonStorey64
    {
        internal ClangCompiler <>f__this;
        internal string includeDirs;

        internal void <>m__D2(string file)
        {
