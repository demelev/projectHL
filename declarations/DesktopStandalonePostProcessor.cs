...
internal abstract class DesktopStandalonePostProcessor
{
    ...
    private void CopyVirtualRealityDependencies()
    {
        if (PlayerSettings.virtualRealitySupported)
        {
            ...
            FileUtil.CopyDirectoryFiltered(EditorApplication.applicationContentsPath + "/VR/" + this.PlatformStringFor(this.m_PostProcessArgs.target), this.StagingAreaPluginsFolder, true, <>f__am$cache2, true);
        }
    }
    ...
    protected virtual void SetupStagingArea()
    {
        ...
        if (this.UseIl2Cpp)
        {
            ...
            IL2CPPUtils.RunIl2Cpp(stagingAreaData, this.GetPlatformProvider(this.m_PostProcessArgs.target), <>f__am$cache3, this.m_PostProcessArgs.usedClassRegistry);
