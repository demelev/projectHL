namespace UnityEditorInternal
{
    ...
    {
        [CompilerGenerated]
        private static Comparison<AnimationWindowKeyframe> <>f__am$cache19;
        [SerializeField]
        ...
        {
            <GetAggregateKeys>c__AnonStorey3A storeya = new <GetAggregateKeys>c__AnonStorey3A {
                hierarchyNode = hierarchyNode
            };
            DopeLine line = this.dopelines.FirstOrDefault<DopeLine>(new Func<DopeLine, bool>(storeya.<>m__5D));
            if (line == null)
            {
                return null;
            }
        ...
        public void SaveCurve(AnimationWindowCurve curve)
        {
            ...
            {
                <>f__am$cache19 = (a, b) => a.time.CompareTo(b.time);
            }
            curve.m_Keyframes.Sort(<>f__am$cache19);
        ...
        public List<DopeLine> dopelines
        {
            get
            {
                if (this.m_dopelinesCache == null)
                {
                    ...
                    if (this.hierarchyData != null)
                    {
                        foreach (TreeViewItem item in this.hierarchyData.GetVisibleRows())
                        {
        ...
        public bool recording
        {
            ...
            set
            {
                ...
                else if (!value && AnimationMode.InAnimationMode())
                {
        ...
        [CompilerGenerated]
        private sealed class <GetAggregateKeys>c__AnonStorey3A
        {
            internal AnimationWindowHierarchyNode hierarchyNode;

            internal bool <>m__5D(DopeLine e)
            {
