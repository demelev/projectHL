namespace UnityEditorInternal
{
    ...
    {
        [CompilerGenerated]
        private static Func<Unity.DataContract.PackageInfo, bool> <>f__am$cache2;
        ...
        private static Unity.DataContract.PackageInfo FindIl2CppPackage()
        {
            ...
            return ModuleManager.packageManager.unityExtensions.FirstOrDefault<Unity.DataContract.PackageInfo>(<>f__am$cache2);
        }
        ...
        public virtual bool usePrecompiledHeader
        {
            get
            {
                return false;
