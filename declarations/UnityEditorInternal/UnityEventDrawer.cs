namespace UnityEditorInternal
{
    ...
    public class UnityEventDrawer : PropertyDrawer
    {
        ...
        [CompilerGenerated]
        private static Func<System.Type, string> <>f__am$cache12;
        [CompilerGenerated]
        private static Func<ValidMethodMap, int> <>f__am$cache13;
        [CompilerGenerated]
        private static Func<ValidMethodMap, string> <>f__am$cache14;
        [CompilerGenerated]
        private static Func<System.Reflection.ParameterInfo, System.Type> <>f__am$cache8;
        [CompilerGenerated]
        ...
        [CompilerGenerated]
        private static Func<System.Reflection.ParameterInfo, System.Type> <>f__am$cacheC;
        [CompilerGenerated]
        ...
        private static GenericMenu BuildPopupList(UnityEngine.Object target, UnityEventBase dummyEvent, SerializedProperty listener)
        {
            ...
            if (gameObject != null)
            {
                ...
                System.Type[] delegateArgumentsTypes = dummyEvent.GetType().GetMethod("Invoke").GetParameters().Select<System.Reflection.ParameterInfo, System.Type>(<>f__am$cacheC).ToArray<System.Type>();
        ...
        private void DrawEventListener(Rect rect, int index, bool isactive, bool isfocused)
        {
            ...
            PersistentListenerMode mode = GetMode(property3);
            switch (mode)
            {
        ...
        private static void GeneratePopUpForType(GenericMenu menu, UnityEngine.Object target, bool useFullTargetName, SerializedProperty listener, System.Type[] delegateArgumentsTypes)
        {
            ...
            if (delegateArgumentsTypes.Length != 0)
            {
                ...
                if (methods.Count > 0)
                {
                    ...
                    menu.AddDisabledItem(new GUIContent(targetName + "/Dynamic " + string.Join(", ", delegateArgumentsTypes.Select<System.Type, string>(<>f__am$cache12).ToArray<string>())));
        ...
        private static string GetEventParams(UnityEventBase evt)
        {
            ...
            System.Type[] typeArray = info.GetParameters().Select<System.Reflection.ParameterInfo, System.Type>(<>f__am$cache8).ToArray<System.Type>();
