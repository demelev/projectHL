namespace UnityEditorInternal
{
    ...
    internal class ProfilerInstrumentationPopup : PopupWindowContent
    {
        ...
        private class InputData : PopupList.InputData
        {
            ...
            {
                <BuildQuery>c__AnonStorey99 storey = new <BuildQuery>c__AnonStorey99 {
                    prefix = prefix
                };
                ...
                return base.m_ListElements.Where<PopupList.ListElement>(new Func<PopupList.ListElement, bool>(storey.<>m__1C3));
            }

            [CompilerGenerated]
            private sealed class <BuildQuery>c__AnonStorey99
            {
                internal string prefix;

                internal bool <>m__1C3(PopupList.ListElement element)
                {
