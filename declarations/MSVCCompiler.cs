...
internal class MSVCCompiler : NativeCompiler
{
    ...
    {
        <CompileDynamicLibrary>c__AnonStorey69 storey = new <CompileDynamicLibrary>c__AnonStorey69 {
            <>f__this = this
        };
        ...
        NativeCompiler.ParallelFor<string>(source, new Action<string>(storey.<>m__E9));
    ...
    [CompilerGenerated]
    private sealed class <CompileDynamicLibrary>c__AnonStorey69
    {
        internal MSVCCompiler <>f__this;
        internal string includePathsString;

        internal void <>m__E9(string file)
        {
