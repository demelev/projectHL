namespace SimpleJson.Reflection
{
    ...
    internal class ReflectionUtils
    {
        ...
        {
            <GetConstructorByReflection>c__AnonStorey1 storey = new <GetConstructorByReflection>c__AnonStorey1 {
        ...
        public static GetDelegate GetGetMethodByReflection(FieldInfo fieldInfo)
        {
            ...
            return new GetDelegate(storey.<>m__2);
        }
        ...
        public static GetDelegate GetGetMethodByReflection(PropertyInfo propertyInfo)
        {
            ...
            return new GetDelegate(storey.<>m__1);
        }
        ...
        public static SetDelegate GetSetMethodByReflection(FieldInfo fieldInfo)
        {
            ...
            return new SetDelegate(storey.<>m__4);
        }
        ...
        public static SetDelegate GetSetMethodByReflection(PropertyInfo propertyInfo)
        {
            ...
            return new SetDelegate(storey.<>m__3);
        }
        ...
        [CompilerGenerated]
        private sealed class <GetConstructorByReflection>c__AnonStorey1
        {
        ...
        private sealed class <GetGetMethodByReflection>c__AnonStorey2
        {
            ...
            internal object <>m__1(object source)
            {
        ...
        private sealed class <GetGetMethodByReflection>c__AnonStorey3
        {
            ...
            internal object <>m__2(object source)
            {
        ...
        private sealed class <GetSetMethodByReflection>c__AnonStorey4
        {
            ...
            internal void <>m__3(object source, object value)
            {
        ...
        private sealed class <GetSetMethodByReflection>c__AnonStorey5
        {
            ...
            internal void <>m__4(object source, object value)
            {
